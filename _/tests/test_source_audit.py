...
spec = importlib.util.spec_from_file_location('type_contract_audit', HERE / 'current_idric_check_types.py')
...
class SourceAuditTests(unittest.TestCase):
    ...
    def test_mutations_are_rejected(self):
        mutations = [
            ('Connector', 'AccessTokenSupport (trustpay, bank_transfer)', 'AccessTokenSupport (trustpay, card)'),
            ...
            ('Connector', 'access_token_support = AccessTokenSupport', 'access_token_support = FileStorageSupport'),
            ('PaymentMethod', 'Inactive_to_active : PaymentMethodTransition (payment_method_inactive, payment_method_active)', 'Inactive_to_active : PaymentMethodTransition (payment_method_active, payment_method_inactive)'),
